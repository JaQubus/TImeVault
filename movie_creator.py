...
async def main():
    ...
    """
    image_folder = "path_to_images"  # Replace with your image folder
    temp_video_path = "temp_video.mp4"  # Temporary video file
    final_video_path = "final_video_with_music.mp4"  # Final video with music
    audio_file_path = "background_music.mp3"  # Replace with your audio file

    # Create the video from images
    try:
        await create_video_from_images(image_folder, temp_video_path, fps=24)
